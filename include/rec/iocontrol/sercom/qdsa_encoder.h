...
public:
  ...
  void set_DO( std::string name, boost::uint8_t value );
  bool get_DO( std::string name ) const;
  ...
  void set_DI( std::string name, boost::uint8_t value );
  boost::uint8_t get_DI( std::string name ) const;
  ...
  boost::uint16_t get_AD( std::string name ) const;
