...
#define NUM_BYTES_P2Q (NUM_BYTES_P2M+NUM_SLAVES*NUM_BYTES_P2S)
#define NB_P2Q_FULL (NB_START + NUM_BYTES_P2Q + NB_STOP)
...
#define NUM_BYTES_Q2P (NUM_BYTES_M2P+NUM_SLAVES*NUM_BYTES_S2P)
#define NB_Q2P_FULL (NB_START + NUM_BYTES_Q2P + NB_STOP)
